...
class ModaldynamixGrailsPlugin extends Plugin {
	...
	def documentation = "http://grails.org/plugin/modaldynamix"
	def license = "APACHE"
	def author = "Vahid Hedayati"
	def authorEmail = "badvad@gmail.com"
	def issueManagement = [system: 'GITHUB', url: 'https://github.com/vahidhedayati/modaldynamix/issues']
	def scm = [url: 'https://github.com/vahidhedayati/modaldynamix']
}
